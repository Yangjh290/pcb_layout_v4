...
from app.services.layout_service.SSA.ssa_utils import generate_rules, separate_rules, generate_back_rules, \
...
def uniform_layout_service(symbols, modules, objective_board):
